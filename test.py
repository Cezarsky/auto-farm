...
HARVEST_PASSES_MAX = 3    # ile razy max powtórzyć zbiór, zanim przejdziemy dalej
    ...
    for dx in range(-RADIUS, RADIUS + 1):
        for dz in range(-RADIUS, RADIUS + 1):
            ...
            if should_break_crop(above):
                ...
                # ✅ klucz: daj 1 tick po spojrzeniu, żeby celowanie “zaskoczyło”
                wait_one_tick()

                attack_for_ticks(ATTACK_TICKS)
                harvested += 1

                # mała pauza na update bloku/dropy
                time.sleep(0.02)
    return harvested
